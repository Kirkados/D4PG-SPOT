...
class Settings:
    ...
    RUN_NAME               = 'velocity_penalty50_gamma1_4piend_random' # use just the name. If trying to restore from file, use name along with timestamp
    ENVIRONMENT            = 'SPOT'
    AGENT                  = ''
    RECORD_VIDEO           = True
    ...
    # Hyperparameters
    NUMBER_OF_ACTORS        = 10
    NUMBER_OF_EPISODES      = 8e5 # that each agent will perform
